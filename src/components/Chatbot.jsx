    ...
    <div>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed z-20 bottom-20 right-6 size-14 rounded-full bg-white/20 border-2 backdrop-blur-3xl border-white/30  mb-10 text-2xl shadow-lg flex items-center justify-center hover:bg-bright-purple transition"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#9A70F5" className="size-8 hover:fill-black">
