// GradualBlur — progressive backdrop-blur overlay for a container or page edge.
// Vendored from React Bits (github.com/ansh-dhanani). Kept close to source so it
// can be re-synced upstream; tuning happens at the call site, not in here.
//
// Note: React Bits lists `mathjs` as a dependency, but this source only uses the
// native Math.* API — no extra package is required or installed.
